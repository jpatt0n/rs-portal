    ...
    <div id="container">
      ...
      <div id="player">
        <div id="overlay">
          ...
          <div id="connectedTools" className="connected-tools" hidden>
            <button
              id="statsToggle"
            ...
            <button
              id="inputSettingsToggle"
              className="connected-icon-button"
              type="button"
              aria-expanded="false"
            ...
            <button
              id="micToggleButton"
              className="connected-icon-button mic-toggle"
              type="button"
              aria-pressed="false"
              aria-label="Mute microphone"
              title="Mute microphone"
            >
              <svg className="mic-icon mic-icon--live" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                <path d="M12 14a3 3 0 0 0 3-3V5a3 3 0 0 0-6 0v6a3 3 0 0 0 3 3Zm5-3a5 5 0 0 1-10 0H5a7 7 0 0 0 6 6.92V21h2v-3.08A7 7 0 0 0 19 11h-2Z" />
              </svg>
              <svg className="mic-icon mic-icon--muted" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                <path d="M15 11V5a3 3 0 0 0-5.94-.6l5.85 5.85c.06-.08.09-.16.09-.25Zm4 0h-2a4.98 4.98 0 0 1-.82 2.74l1.45 1.45A6.96 6.96 0 0 0 19 11ZM3.41 2.86 2 4.27l7 7V11a3 3 0 0 0 3 3c.22 0 .43-.03.63-.08l1.83 1.83A5 5 0 0 1 7 11H5a7 7 0 0 0 6 6.92V21h2v-3.08a6.9 6.9 0 0 0 2.86-1.05l3.87 3.87 1.41-1.41L3.41 2.86Z" />
              </svg>
            </button>
          </div>
          <div
          ...
          <div id="greenRoomBanner" className="green-room-banner" aria-live="polite" hidden>
            <div id="greenRoomTitle" className="green-room-title">
              You are in the green room
            </div>
            <div id="greenRoomDetail" className="green-room-detail">
              You can see and hear the show, but nobody can see or hear you: your microphone is off
              and your camera is not being sent. A cast member will bring you in.
            </div>
          </div>
